...
namespace Pdc.System.Sample.Components
{
    ...
    /// 
    /// </summary>
    public class SampleChannelCollection : IChannelsCollection
    {
        ...
        /// 
        /// </summary>
        public SampleChannelCollection()
        {
            _channels = new List<IComponentChannel>
            {
                new NamedChannel(FAA_API)
            };
        }
        ...
        {
            get { return _channels.Single(c => c.Name.Equals(channelName)); }
        }
    }
}